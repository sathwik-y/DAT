...
// TODO: Update the JWT TO cookie instead of local storage
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(request -> request
                .requestMatchers("/register", "/login","/api/auth/verify","/request-password-reset","/verify-reset-otp","/reset-password","/verify-otp","/register/bulk","/first-login-password-change","/actuator/**").permitAll()
